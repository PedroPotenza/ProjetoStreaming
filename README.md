...
- Se atente ao enunciado e aos casos de teste em aberto, você consegue ter uma noção bem melhor do fluxo de cada função ao ler as possíveis mensagens de erro.
- Caso tenha dificuldade em entender como uma função funcionaria, experimente escrever ela de maneira simples em comentários, apenas com a lista de eventos que é necessário acontecer e em seguida implemente passo a passo.
